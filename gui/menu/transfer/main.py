...
def transfer(app, sesi):
    ...
    if auth == True:
        ...
        canvas.create_text(
            ...
            222.0,
            anchor="nw",
            text="Usernama atau Nomor Kartu Tujuan",
            fill="#000000",
            font=("Poppins Medium", 16 * -1)
        )
        # buat inputan
        ...
        inominal_img = PhotoImage(file=akses_aset_media("image_5.png", LOC))
        ...
        lanjut_btn = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: transfer_handle(app,canvas, sesi, inputs),
            relief="flat"
        )
        lanjut_btn.place(
            x=466.0,
