...
def tarik_handler(app, frame, inputs, sesi):
    auth = sesi['auth']
    user = sesi['data']
    ...
    if auth == True:
        ...
        from .main import tarik
        koreksiBtn = ctk.CTkButton(frame['footer'], height=50,text="Koreksi", fg_color='orange', text_color='black', command=lambda : tarik(app, frame, sesi))
